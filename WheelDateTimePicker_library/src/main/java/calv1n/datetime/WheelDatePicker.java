...
/**
 *
 * Created by calvin on 2015/2/25.
 */
public class WheelDatePicker {
	 ...
	 */
	public WheelDatePicker(FragmentManager fm) {
		// See if there are any DialogFragments from the FragmentManager
		FragmentTransaction ft = fm.beginTransaction();
		Fragment prev = fm.findFragmentByTag(DatePickerFragment.class.getName());
	 ...
	 * @param listener
	 */
	public void setListener(DatePickerFragment.OnDateSetListener listener) {
		mListener = listener;
	}
	 ...
	 * {@link #setListener(calv1n.datetime.DatePickerFragment.OnDateSetListener)} )} ()} before calling this.
	 */
	public void show() {
		if (mListener == null) {
		...
		DatePickerFragment dialogFragment = DatePickerFragment.newInstance(mListener, mInitialDate);
		dialogFragment.show(mFragmentManager, DatePickerFragment.class.getName());
	}
	...
	public static class Builder {
		...
		public Builder setListener(DatePickerFragment.OnDateSetListener listener) {
		 ...
		 * @return
		 */
		public WheelDatePicker build() {
			WheelDatePicker picker = new WheelDatePicker(fm);
